...
namespace YakumoAkai.character.relics
{
    ...
    public class GensokyoOnlineBad : RelicModel
    {
        ...
        public override async Task AfterSideTurnStart(CombatSide side, IReadOnlyList<Creature> participants, ICombatState combatState)
        {
            ...
            {
                Flash(); // 触发遗物图标闪烁
                await PowerCmd.Apply<mp>(new ThrowingPlayerChoiceContext(), base.Owner.Creature, 60m,
            ...
            {
                Flash(); // 触发遗物图标闪烁
                await PowerCmd.Apply<mp>(new ThrowingPlayerChoiceContext(), base.Owner.Creature, 10m,
                    base.Owner.Creature, null);
            }
