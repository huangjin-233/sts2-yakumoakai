...
namespace YakumoAkai.character.relics
{
    ...
    public sealed class GensokyoOnline : RelicModel
    {
        ...
        public override async Task AfterSideTurnStart(CombatSide side, IReadOnlyList<Creature> participants, ICombatState combatState)
        {
            ...
            {
                Flash(); // 触发遗物图标闪烁
                await PowerCmd.Apply<mp>(new ThrowingPlayerChoiceContext(), base.Owner.Creature, 80m, base.Owner.Creature, null);
            ...
            {
                Flash(); // 触发遗物图标闪烁
                await PowerCmd.Apply<mp>(new ThrowingPlayerChoiceContext(), base.Owner.Creature, 15m, base.Owner.Creature, null);
            }
