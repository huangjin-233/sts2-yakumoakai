...
namespace YakumoAkai.character.card.uncommon
{
    ...
    public sealed class ZombieHat : ModCardTemplate
    {
        ...
        {
            await PowerCmd.Apply<Zombiedex>(choiceContext,base.Owner.Creature, -base.DynamicVars.Power<DexterityPower>().BaseValue, base.Owner.Creature, this);//临时敏捷
            await PowerCmd.Apply<Zombiestrength>(choiceContext,base.Owner.Creature, base.DynamicVars.Power<StrengthPower>().BaseValue, base.Owner.Creature, this);//临时力量
            if (base.Owner.Creature.HasPower<mp>() && base.Owner.Creature.GetPowerAmount<mp>() >= 15)
            {
                await PowerCmd.Apply<StrengthPower>(choiceContext, base.Owner.Creature, 1, base.Owner.Creature, this);//力量
                await PowerCmd.Apply<mp>(choiceContext, base.Owner.Creature, -15, base.Owner.Creature, this);
